...
@dataclass
class SchemeAaSortingParameters:
    """Parameters for MountainSort sorting scheme AA ("Artifact-Aware")
    ...
    - training_ratio: the ratio of the training data
    ...
    """
    artifact_winlen_sec: float
    artifact_winmask: np.ndarray
    ...
    training_ratio: Union[float, None] = None
    max_training_duration_sec: Union[float, None] = None
